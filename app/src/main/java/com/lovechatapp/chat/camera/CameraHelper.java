package com.lovechatapp.chat.camera;
...
//            start();
    ...
    public static final class Builder {
        ...
        public CameraHelper build() {
            if (previewViewSize == null) {
                LogUtil.e(TAG, "previewViewSize is null, now use default previewSize");
            }
            if (cameraListener == null) {
                LogUtil.e(TAG, "cameraListener is null, callback will not be called");
            }
