            ...
            case R.id.submit_tv: {//保存
                ...
                if (content.equals(getResources().getString(R.string.save_safely))) {
                    ...
                    if (TextUtils.isEmpty(realName)) {
                        ToastUtil.INSTANCE.showToast(getApplicationContext(), R.string.please_input_real_name);
                        return;
                    }
                    String weChatNumber = mWeChatAccountEt.getText().toString().trim();
                    if (TextUtils.isEmpty(weChatNumber)) {
                        ToastUtil.INSTANCE.showToast(getApplicationContext(), R.string.please_bind_we_chat);
                        return;
                    }
                    //收款码
