...
//        MAKEUP_FILTERS.put(R.string.makeup_freckles, Pair.create(FilterEnum.warm.filter(), 0.4f));
    ...
    public static List<FaceMakeup> getBeautyFaceMakeup() {
        ...
        FaceMakeup peachBlossom = new FaceMakeup(peachBlossomMakeups, R.string.makeup_peach_blossom, R.drawable.demo_makeup_peachblossom, Filter.Key.FENNEN_3);
        ...
        FaceMakeup grape = new FaceMakeup(grapeMakeups, R.string.makeup_grapefruit, R.drawable.demo_makeup_grapefruit, Filter.Key.LENGSEDIAO_4);
        ...
        FaceMakeup clear = new FaceMakeup(clearMakeups, R.string.makeup_clear, R.drawable.demo_makeup_clear, Filter.Key.XIAOQINGXIN_1);
        ...
        FaceMakeup boyFriend = new FaceMakeup(boyFriendMakeups, R.string.makeup_boyfriend, R.drawable.demo_makeup_boyfriend, Filter.Key.XIAOQINGXIN_3);
