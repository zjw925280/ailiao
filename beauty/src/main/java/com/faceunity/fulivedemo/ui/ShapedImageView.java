...
public class ShapedImageView extends AppCompatImageView {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mStrokeWidth = a.getDimension(R.styleable.ShapedImageView_b_stroke_width, 0);
            mStrokeColor = a.getColor(R.styleable.ShapedImageView_b_stroke_color, mStrokeColor);
            a.recycle();
        }
