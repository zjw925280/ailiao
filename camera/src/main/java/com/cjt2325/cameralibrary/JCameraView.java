...
//    private static final String TAG = "JCameraView";
    ...
    private void initView() {
        ...
        mSwitchCamera.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
               int curCamera = machine.swtich(mVideoView.getHolder(), screenProp);
                if (curCamera == CameraInterface.getInstance().CAMERA_FRONT_POSITION) {
                    mFlashLamp.setVisibility(View.GONE);
                } else{
