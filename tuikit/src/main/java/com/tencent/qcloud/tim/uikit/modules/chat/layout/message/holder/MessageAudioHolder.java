...
public class MessageAudioHolder extends MessageContentHolder {
    ...
    private static final int AUDIO_MAX_WIDTH = ScreenUtil.getPxByDp(220);
    ...
    public void layoutVariableViews(final MessageInfo msg, final int position) {
        ...
        if (msg.isSelf()) {
            ...
            audioPlayImage.setImageResource(R.drawable.voice_msg_other3);
            audioContentView.removeView(audioPlayImage);
            audioContentView.addView(audioPlayImage);
            unreadAudioText.setVisibility(View.GONE);
            audioTimeText.setTextColor(0xffFE2947);
        } else {
            audioTimeText.setTextColor(0xff333333);
        ...
        if (!(elem instanceof TIMSoundElem || elem instanceof TIMCustomElem)) {
            return;
        }
        ...
        if (elem instanceof TIMCustomElem) {
            unreadAudioText.setVisibility(View.GONE);
            ImCustomMessage imCustomMessageBean = (ImCustomMessage) msg.getExtra();
            try {
                duration = Integer.parseInt(imCustomMessageBean.duration);
            } catch (Exception e) {
                e.printStackTrace();
            }
            msg.setDataPath(imCustomMessageBean.fileUrl);
        }
        //语音消息处理
        else {
        ...
        msgContentFrame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                audioPlayImage.setImageResource(msg.isSelf() ? R.drawable.play_voice_message_other : R.drawable.play_voice_message);
                    ...
                    public void onCompletion(Boolean success) {
                        audioPlayImage.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                audioPlayImage.setImageResource(msg.isSelf() ? R.drawable.voice_msg_other3 : R.drawable.voice_msg_playing_3);
                            }
                        });
                    }
                });
